...
// هنا انا بستدعي كل الفنكشن  اللي في الكونتكست عشان اقدر استخدمهم هنا
              ...
              <div key={product._id} className="row border-bottom py-3">
                ...
                <div className="col-md-11 d-flex justify-content-between">
                  <div>
                    ...
                    <button className="btn p-0" onClick={()=>removeItem(product.product.id)}>
                      <i className="fas fa-trash-can text-main"></i> Remove
                    </button>
                  </div>

                  <div className="d-flex align-items-center">
                    <button onClick={()=>updateCount(product.product._id ,product.count+1)} className="btn btn-sm border ">+</button>
